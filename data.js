...
const DUCK_TRACKS = [
  ...
  {a:'Waave ft. Duck',t:'Mohamed',g:'trap',r:['Beat','Feature'],cover:'images/covers/gun-256x234.png',yt:'https://www.youtube.com/watch?v=1kjwszuYRt8'},
  ...
  {a:'Dayo',t:'Desce Sobe',g:'trap',r:['Beat'],cover:'images/covers/capa-desce-sobe-256x256.png',yt:'https://www.youtube.com/watch?v=cIraeWrxjVI'},
  {a:'Duck4x',t:'Eu Que Mando',g:'pop',r:['Produção'],cover:'images/covers/eu-que-mando-256x247.png',yt:'https://www.youtube.com/watch?v=SwD7EGmOYQs'},
  {a:'Duck4x',t:'Gostosa',g:'pop',r:['Produção'],cover:'images/covers/gostosa-256x256.png',yt:'https://www.youtube.com/watch?v=dmruk8j3IsQ'},
  {a:'Duck4x',t:'Love Me',g:'pop',r:['Produção'],cover:'images/covers/love-me-256x245.png',yt:'https://www.youtube.com/watch?v=9hbB47ckn-c'},
  {a:'Duck4x',t:'One RPM',g:'pop',r:['Produção'],cover:'images/covers/one-rpm-256x256.jpg',yt:'https://www.youtube.com/watch?v=XzvZwxJaYd4'},
  {a:'Duck4x',t:'Capa Brilho do Luar',g:'pop',r:['Produção'],cover:'images/covers/capa-brilho-do-luar-256x256.jpg',yt:'https://www.youtube.com/watch?v=ALVzhUp5DpM'},
];
...
const DUCK_IMAGES = {
  ...
  studio:["images/studio/setup-2-1440x960.jpg","images/studio/setup-3-1440x960.jpg","images/studio/setup-4-1440x960.jpg","images/studio/setup-5-1440x960.jpg","images/studio/mix-3-1440x960.jpg","images/studio/mix-6-1440x960.jpg"],
  studioLabels:["Home Studio","Mix Station","Production","Recording","Mixing","Mastering"],
  aboutImg:"images/studio/setup-2-1920x1280.jpg",
};
...
const DUCK_I18N = {
  pt:{
    ...
    sp1:'Sou Duck, produtor musical, beatmaker e engenheiro de som de Aracaju, Sergipe. Meu cérebro processa o som de um jeito diferente. Não é só ouvir música, é decompô-la em camadas: frequências, harmonias, texturas, emoções. Tenho uma configuração neurocognitiva que me permite visualizar as harmonias acústicas antes mesmo de tocar uma nota. Comecei aos 12 anos sem recursos, só com a vontade de entender como o som é feito. Aos 14 entrei no Conservatório de Música de Sergipe e ali entendi que não era talento comum. Era uma forma diferente de processar a realidade sonora.',
    sp2:'Trabalho com artistas de escala nacional e internacional. Do Trap brasileiro ao Pop que cruza fronteiras. Da Seleção Brasileira ao palco internacional. Minha especialidade é interpretar harmonicamente o que o artista quer comunicar e transformar isso em engenharia de som. Não produzo beats genéricos. Cada projeto passa por um diagnóstico sonoro profundo: o cérebro mapeia frequências, identifica ressonâncias e prevê como cada elemento vai conversar com os outros. Quando um artista me traz uma ideia, eu vejo a música inteira. A estrutura, os timbres, o ar que ela precisa respirar.',
    quote:'"Quando Duck olha para uma música, ele não vê notas. Vê arquiteturas. É como se o cérebro dele processasse o som em 3D, mapeando cada frequência antes de ela existir. Não é produtividade, é uma forma de existir que poucos têm."',
    quoteA:'— Produção Musical',
    ...
    sn2:'Gravação',sd2:'Sessões no estúdio com tratamento acústico de nível profissional. Direção criativa em cada take. Sei quando o artista deu o melhor de si.',
    ...
    p3t:'Mixagem & Revisão',p3d:'Aqui entra a engenharia de som. Trato cada stem com EQ dinâmico, compressão paralela, automação de panning e reverberação espacial. O objetivo é separar frequentes, criar profundidade e manter a energia. Até 3 rodadas de revisão para afinar cada detalhe.',
  ...
  es:{
    ...
    sp1:'Soy Duck, productor musical, beatmaker e ingeniero de sonido de Aracaju, Sergipe. Mi cerebro procesa el sonido de forma diferente. No es solo escuchar música, es deponerla en capas: frecuencias, armonías, texturas, emociones. Tengo una configuración neurocognitiva que me permite visualizar las armonías acústicas antes mismo de tocar una nota. Empecé a los 12 años sin recursos, solo con las ganas de entender cómo se hace el sonido. A los 14 entré al Conservatorio de Música de Sergipe y ahí entendí que no era talento común. Era una forma diferente de procesar la realidad sonora.',
    sp2:'Trabajo con artistas de escala nacional e internacional. Del Trap brasileño al Pop que cruza fronteras. De la Selección Brasileña al escenario internacional. Mi especialidad es interpretar armónicamente lo que el artista quiere comunicar y transformarlo en ingeniería de sonido. No produzco beats genéricos. Cada proyecto pasa por un diagnóstico sonoro profundo: el cerebro mapea frecuencias, identifica resonancias y predice cómo cada elemento va a conversar con los otros. Cuando un artista me trae una idea, veo la música entera. La estructura, los timbres, el aire que necesita respirar.',
    quote:""Cuando Duck mira una música, él no ve notas. Ve arquitecturas. Es como si su cerebro procesara el sonido en 3D, mapeando cada frecuencia antes de que exista. No es productividad, es una forma de existir que pocos tienen."",
    quoteA:'— Producción Musical',
  ...
  en:{
    ...
    sp1:'I\'m Duck, music producer, beatmaker, and sound engineer from Aracaju, Sergipe. My brain processes sound differently. It\'s not just hearing music, it\'s deconstructing it into layers: frequencies, harmonics, textures, emotions. I have a neurocognitive configuration that allows me to visualize acoustic harmonics before even playing a note. I started at 12 with no resources, just the will to understand how sound is made. At 14 I entered the Sergipe Music Conservatory and that\'s when I realized it wasn\'t common talent. It was a different way of processing sonic reality.',
    sp2:'I work with artists at national and international scale. From Brazilian Trap to Pop that crosses borders. From the Brazilian national team to international stages. My specialty is harmonically interpreting what the artist wants to communicate and transforming it into sound engineering. I don\'t produce generic beats. Every project goes through a deep sonic diagnosis: the brain maps frequencies, identifies resonances, and predicts how each element will converse with the others. When an artist brings me an idea, I see the whole song. The structure, the timbres, the air it needs to breathe.',
    quote:'"When Duck looks at music, he doesn\'t see notes. He sees architectures. It\'s like his brain processes sound in 3D, mapping every frequency before it exists. It\'s not productivity, it\'s a way of existing that few have."',
    quoteA:'— Music Production',
    ...
    sn2:'Recording',sd2:'Professional-grade acoustic treatment sessions. Creative direction on every take. I know when the artist gave their best.',
